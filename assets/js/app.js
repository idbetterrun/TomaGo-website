        ...
        function router() {
            ...
            if (targetView) {
                ...
                window.scrollTo(0, 0);
                // Light-page navbar adaptation
                if (targetView.classList.contains('light-page')) {
                    navbar.classList.add('light-page');
                } else {
                    navbar.classList.remove('light-page');
                }
        ...
        window.addEventListener('scroll', () => {
            if (window.scrollY > 50) {
                navbar.classList.add('scrolled', 'bg-black/80', 'backdrop-blur-md', 'py-4', 'border-b', 'border-white/10');
                navbar.classList.remove('py-6');
            } else {
                navbar.classList.remove('scrolled', 'bg-black/80', 'backdrop-blur-md', 'py-4', 'border-b', 'border-white/10');
